# Generated by Django 5.0.4 on 2025-10-16 14:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='OptionForm',
            fields=[
                ('optionId', models.CharField(max_length=3, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('optionId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.optionform')),
